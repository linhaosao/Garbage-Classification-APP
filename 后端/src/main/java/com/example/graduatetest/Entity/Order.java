...
public class Order {
    ...
    public Order(Integer order_id, String order_phonenumber, String order_position, String order_detail, String order_date, String order_status, String order_cat) {
        Order_id = order_id;
        Order_phonenumber = order_phonenumber;
        Order_position = order_position;
        Order_detail = order_detail;
